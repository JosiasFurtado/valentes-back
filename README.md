...
$ docker run --name valentes-postgres -e POSTGRES_USER=docker \
              -e POSTGRES_DB=valentes -e POSTGRES_PASSWORD=docker \
              -p 5432:5432 -d postgres

# Crie uma instancia do mongoDB usando docker
$ docker run --name valentes-mongodb -p 27017:27017 -d -t mongo

# Crie uma instancia do redis usando docker
$ docker run --name valentes-redis -p 6379:6379 -d -t redis:alpine
